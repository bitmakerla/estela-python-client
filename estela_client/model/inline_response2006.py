...
class InlineResponse2006(ModelNormal):
    ...
    def _from_openapi_data(cls, count, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            previous (str, none_type): URI to the previous data chunk.. [optional]  # noqa: E501
            next (str, none_type): URI to the next data chunk.. [optional]  # noqa: E501
            results ([bool, date, datetime, dict, float, int, list, str, none_type]): Data items.. [optional]  # noqa: E501
        """
