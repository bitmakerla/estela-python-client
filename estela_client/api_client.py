...
from estela_client import rest
from estela_client.configuration import Configuration
from estela_client.exceptions import ApiTypeError, ApiValueError, ApiException
from estela_client.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.api_account_change_password_change  # this is an instance of the class Endpoint
        api_instance.api_account_change_password_change()  # this invokes api_instance.api_account_change_password_change.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.api_account_change_password_change.callable or self.callable in this class
