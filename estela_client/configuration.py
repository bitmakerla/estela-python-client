...
class Configuration(object):
    ...
    conf = estela_client.Configuration(
        username='the-user',
    ...
    def __init__(
        ...
        """Constructor"""
        self._base_path = "http://127.0.0.1:8000" if host is None else host
        """Default Base url
        """
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("estela_client")
